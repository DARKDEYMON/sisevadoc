...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('evaluacion', '0005_auto_20180608_1010'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='gestion',
            field=models.PositiveIntegerField(default=2018, validators=[django.core.validators.RegexValidator(code='dato solo numerico', message='El año solo contiene cuatro digitos numericos', regex='^[0-9]{4}$')]),
        ),
        migrations.AddField(
